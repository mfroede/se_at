...
durch Aus- und Einkommentierung bei dem Austausch von View Implementierungen.
...
generiert, jedoch sind weitere Verhalten wie z.B. das Öffnen eines Popups nicht umgesetzt.

Durch Abschnitt \ref{Probleme} wird ersichtlich, dass die vorzunehmende Änderung im
Bereich der View Komponenten innerhalb der \texttt{.ui.xml}-Datei keine optimale
